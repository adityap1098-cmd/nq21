...
- Mekanik Budi sendirian (share 100%), rate Jasa = 25%.
- Komisi Budi = (200.000 − 50.000) × 1.0 × 0.25 = **Rp37.500**
...
## 12. Design System (LOCKED — sumber: `demo.html`)
...
- **Badge**: 11px font, 0.06em letter-spacing, type-coded color
